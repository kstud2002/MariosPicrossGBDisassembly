...
GS06_GameBoardRestoreAfterGameOverTileData::
    INCBIN "gfx/GS06_GameBoardRestoreAfterGameOverTileData.2bpp"

GS06_MessageRedrawSourceTileData::
    INCBIN "gfx/GS06_MessageRedrawSourceTileData.2bpp"
